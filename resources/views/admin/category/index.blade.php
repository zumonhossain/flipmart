...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-outline-success">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> Add Category </h4>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-12">
            <div class="card card-outline-success">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> All Category</h4>
                </div>
                <div class="card-body">
                    <table id="alltableinfo" class="table table-bordered table-striped table-hover custom_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn-success view-icon" href="{{ url('admin/category/view/'.$item->category_slug) }}"><i class="mdi mdi-library-plus"></i></a>
                                    <a class="btn-warning edit-icon" href="{{ url('admin/category/edit/'.$item->category_slug) }}"><i class="mdi mdi-table-edit"></i></a>
