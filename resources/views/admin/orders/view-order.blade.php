                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            @elseif($order->status == 'Processing')
                                <a href="{{ url('admin/processing-to-picked/'.$order->id) }}" class="btn btn-block btn-success" id="picked">Picked</a>
                            @elseif($order->status == 'Picked')
                                <a href="{{ url('admin/picked-to-shipped/'.$order->id) }}" class="btn btn-block btn-success" id="shipped">Shipped</a>
                            @elseif($order->status == 'Shipped')
                                <a href="{{ url('admin/shipped-to-delivery/'.$order->id) }}" class="btn btn-block btn-success" id="delevery">Delevery</a>
                            @endif
                        </li>
                    </ul>
                </div>
