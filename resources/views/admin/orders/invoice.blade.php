...
<html lang="en">
    ...
    <body>
        <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
            <tr>
                <td valign="top">
                    <h2 style="color: green; font-size: 26px;"><strong>Tech Man Future</strong></h2>
                </td>
                <td align="right">
                    <pre class="font" >
                    Tech Man Future Head Office
                    Email:zumonhossain10@gmail.com <br>
                    Mob: 01644954478 <br>
                    Dhaka 4321,Dhanmondi:#32 <br>
                    Dhaka ,Bangladesh
                    </pre>
                </td>
            </tr>
