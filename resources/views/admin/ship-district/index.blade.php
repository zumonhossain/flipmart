        ...
        <div class="col-lg-12">
            <div class="card card-outline-success">
                <div class="card-header">
                    <h4 class="user-registration"><i class="mdi mdi-account-circle"></i> Add Ship District </h4>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('district.insert') }}" class="form-horizontal" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="district_name" class="form-control" placeholder="Enter district name" value="{{ old('district_name') }}">
                                @error('district_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <tbody>
                            @foreach($districts as $district)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn-success view-icon" href="{{ url('admin/district/view/'.$district->district_slug) }}"><i class="mdi mdi-library-plus"></i></a>
                                        <a class="btn-warning edit-icon" href="{{ url('admin/district/edit/'.$district->district_slug) }}"><i class="mdi mdi-table-edit"></i></a>
                                        <a class="btn-danger delete-icon" id="softDelete" data-toggle="modal" data-target="#softDelModal" data-id="{{$district->id}}" href="#"><i class="mdi mdi-delete"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
