<div id="hero">
				<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
					<div class="item" style="background-image: url({{ asset('contents/website') }}/assets/images/sliders/01.jpg);">
					...
					<div class="item" style="background-image: url({{ asset('contents/website') }}/assets/images/sliders/02.jpg);">
						<div class="container-fluid">
							<div class="caption bg-color vertical-center text-left">
