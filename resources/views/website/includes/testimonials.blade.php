<div class="sidebar-widget  wow fadeInUp outer-top-vs ">
	<div id="advertisement" class="advertisement">
		<div class="item">
			<div class="avatar">
				<img src="{{ asset('contents/website') }}/assets/images/testimonials/member1.png" alt="Image">
			</div>
		...
		<div class="item">
			<div class="avatar">
				<img src="{{ asset('contents/website') }}/assets/images/testimonials/member3.png" alt="Image">
			</div>
			<div class="testimonials">
				<em>"</em>Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em>
			</div>
		...
		<div class="item">
			<div class="avatar">
				<img src="{{ asset('contents/website') }}/assets/images/testimonials/member2.png" alt="Image">
			</div>
			<div class="testimonials">
				<em>"</em> Vtae sodales aliq uam morbi non sem lacus port mollis. Nunc condime tum metus eud molest sed consectetuer.<em>"</em>
			</div>
