                    ...
                    <div class='col-md-3 sidebar'>
                        ...
                        <div class="sidebar-module-container">
                            <div class="sidebar-filter">
                                ...
                                <!-- ================ SIDEBAR SHOP BY CATEGORY START ===================== -->
                                                ...
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input" name="category[]" id="" value="{{ $cat->category_slug }}" onchange="this.form.submit();" @if (!empty($filterCat) && in_array($cat->category_slug, $filterCat)) checked @endif> {{ $cat->category_name }}
                                                        </label>
                                ...
                                <!-- ================ SIDEBAR SHOP BY CATEGORY END ===================== -->
                                
                                <!-- ================ SIDEBAR SHOP BY BRAND START ===================== -->
                                <div class="sidebar-widget wow fadeInUp">
                                        ...
                                        <div class="accordion">
                                            ...
                                            @foreach ($brands as $brand)
                                                <div class="accordion-group">
                                                    <div class="accordion-heading">
                                                        <label class="form-check-label">
                                                            <input type="checkbox" class="form-check-input" name="brand[]" id="" value="{{ $brand->brand_slug }}" onchange="this.form.submit();" @if (!empty($filterBrand) && in_array($brand->brand_slug, $filterBrand)) checked @endif> {{ $brand->brand_name }}
                                                        </label>
                                                    </div><!-- /.accordion-heading -->
                                                </div><!-- /.accordion-group -->
                                            @endforeach
