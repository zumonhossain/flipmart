...
class OrderController extends Controller{
    ...
    public function pendingToCancel($order_id){
        ...
        $notification=array(
            'messege'=>'Order Cancel Success',
            'alert-type'=>'success'
        );
        return Redirect()->route('order-cancel')->with($notification);
    }
    ...
    public function confirmToProcess($order_id){
        ...
        $notification=array(
            'messege'=>'Order Processing Success',
            'alert-type'=>'success'
        );
    ...
    public function shippedToDelivery($order_id){
        Order::findOrFail($order_id)->update([
            ...
            $notification=array(
            'messege'=>'Order Delivery Success',
            'alert-type'=>'success'
        );
